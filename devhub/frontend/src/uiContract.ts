...
export const portfolioLabels=['Open navigation menu','Primary navigation','Refresh all projects','Create','Add Project','Add Feedback','Projects','CI attention','Open PRs','Release gaps','Release Unknown','More','Less','Roadmap','Project Details'];
