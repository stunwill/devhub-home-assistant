...
export const portfolioLabels=['Open navigation menu','Primary navigation','Refresh all projects','Refreshing projects','Updated just now','Refresh failed','Create','Add Project','Add Feedback','Projects','CI attention','Open PRs','Release gaps','Release Unknown','OPEN PR','Open pull request','Version evidence','More','Less','Roadmap','Project Details','Edit name'];
